...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("3. Ordenar por Loja de Origem");
            System.out.println("4. Ordenar por Loja de Destino");
            ...
            } catch (NumeroArquivoInvalidoException e) {
    ...
    private static void adicionarTransferencia(Scanner scanner) throws NumeroArquivoInvalidoException {
        System.out.print("Número do arquivo: ");
        if (!scanner.hasNextInt()) {
            throw new NumeroArquivoInvalidoException("Número do arquivo inválido. Por favor, digite um número válido.");
        }
    ...
    private static void removerTransferencia(Scanner scanner) throws NumeroArquivoInvalidoException {
    ...
    private static void mostrarTransferenciasOrdenadasPorDestino() {
        if (transferencias.isEmpty()) {
            ...
            System.out.println("\nOrdenado por por Loja de destino:");
            for (Transferencia transferencia : transferencias) {
                System.out.println(transferencia);
            }
        }
